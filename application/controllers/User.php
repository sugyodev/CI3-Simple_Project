...
class User extends BaseController
{
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Simple Dashboard : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Simple Dashboard : Add New User';
    ...
    function modifyUser($userId = NULL)
    {
        ...
        {          
            ...
            $this->global['pageTitle'] = 'Simple Dashboard : Edit User';
